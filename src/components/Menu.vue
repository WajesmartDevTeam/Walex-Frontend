  ...
  >
    <div class="main-menu-content">
      ...
      >
        ...
        <li class=" nav-item"><a href="exchange"><i class="fa fa-sync-alt"></i></i><span class="menu-title">Redeem</span></a>

        </li>

        <li class=" nav-item"><a href="transfer"><i class="fa fa-share-square"></i><span class="menu-title">Transfer</span></a>
        </li>
        <li class=" nav-item"><a href="voucher"><i class="fa fa-gift"></i><span class="menu-title">Buy Gift Cards</span></a>
        </li>
  ...
  methods: {
    logout: function () {
      ...
      this.$store
        ...
        .then(response => {
          this.$swal
            .fire("Success", response.data.detail, "success")
            .then(() => {
              var _this = this;
