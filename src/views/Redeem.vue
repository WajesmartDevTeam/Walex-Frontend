      ...
      <div class="content-wrapper d-flex">
        ...
        <div class="content-body w-100 h-100">
          ...
          <div class="content-header  text-left">
            <h2 class="ml-2">Spend Your Points</h2>
          </div>
          <div class="mt-4 row">
              ...
              <div class="container">
                <div class="frame">
                  ...
                  >
                    ...
                    >
                      <div class="">
                        <label for="receiver">Select Merchant</label>
            ...
            <div class="col">
              <img
                ...
                src="../assets/images/contract5.png"
                alt=""
              />
            </div>
          </div>
    ...
    confirmTransaction () {
      if (this.errors.items.length == 0) {
        ...
        this.$swal.fire({
          ...
          text: "Please confirm Redemption of ₦" + this.credentials.amount + " at " + receiver + "",
          type: 'warning',
